...
# We are going to manually "optimize" this function in the first squashed migration
def create_admin_MUST_ALWAYS_EXIST_original(apps, schema_editor):
    Person = apps.get_model('app', 'Person')
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(create_admin_MUST_ALWAYS_EXIST_original, elidable=False),
        migrations.AddField(
            model_name='person',
            name='dob',
